            ...
            <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
                ...
                <body>
                    ...
                    <div class="container mt-5">
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                <form action="/student/course" method="get" class="row g-3">
                                    <div class="col-md-2">
                                    ...
                                    <tbody>
                                        <c:forEach var="course" items="${courses}">
                                            <tr>
                                                ...
                                                <td>
                                                    <form:form action="/student/add-to-cart/${course.id}" method="post"
                                                        style="margin:0">
                                                        ...
                                                        <input type="hidden" name="lectureHour"
                                                            value="${param.lectureHour}" />
